        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateDate = table.Column<DateTime>(type: "datetime2", rowVersion: true, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ResponseBody = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssignmentResponses_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResponseMaterials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResponseMaterials_AssignmentResponses_ResponseId",
                        column: x => x.ResponseId,
                        principalTable: "AssignmentResponses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResponseMaterials_Materials_MaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignmentResponses_UserId",
                table: "AssignmentResponses",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResponseMaterials_MaterialId",
                table: "ResponseMaterials",
                column: "MaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_ResponseMaterials_ResponseId",
                table: "ResponseMaterials",
                column: "ResponseId");
